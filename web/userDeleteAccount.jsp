...
<html>
    ...
    <body class="backtheme">
        ...
        <div align="right" style="margin-top: -80px ; margin-right: 100px;">
            <st:form action="userdeleteaccountdb.action" >
                <table cellspacing="5" cellpadding="3" style="background-color: rgba(105,91,80,0.5) ;width: 450px;"  >
                    ...
                    <tr><td align="center" colspan="2" ><st:submit value="DELETE" theme="simple"  style="border-radius:10px;font-size:15px;height:30px; width:100px;"  />
